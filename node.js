...
var $;
(function ($) {
    class $doshik_client_steps extends $mol_page {
        doshik_value(next) {
            if (next !== undefined)
                return next;
            return 10000;
        ...
        All_doshik() {
            const obj = new this.$.$mol_text();
            obj.text = () => this.all_doshik_label();
            return obj;
        }
        add_doshik(next) {
            if (next !== undefined)
        ...
        Add_doshik() {
            ...
            obj.value = (next) => this.add_doshik(next);
            obj.value_max = () => 40000;
            return obj;
        }
    ...
    __decorate([
        $mol_mem
    ], $doshik_client_steps.prototype, "doshik_value", null);
    __decorate([
        $mol_mem
    ], $doshik_client_steps.prototype, "All_doshik", null);
    __decorate([
        $mol_mem
    ], $doshik_client_steps.prototype, "add_doshik", null);
    __decorate([
        $mol_mem
    ], $doshik_client_steps.prototype, "Add_doshik", null);
    __decorate([
        $mol_mem
    ], $doshik_client_steps.prototype, "add_today_steps", null);
    __decorate([
        $mol_mem
    ], $doshik_client_steps.prototype, "Add_doshik_save", null);
    $.$doshik_client_steps = $doshik_client_steps;
})($ || ($ = {}));
//doshik/client/steps/-view.tree/steps.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $doshik_client_steps extends $.$doshik_client_steps {
            add_today_steps() {
                if (this.add_doshik() > 0)
                    this.doshik_value(this.doshik_value() + this.add_doshik());
            }
            all_doshik_label() {
...
//doshik/client/steps/steps.view.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $doshik_company_report extends $mol_page {
        title() {
            return "Отчёт";
        }
        body() {
    ...
    __decorate([
        $mol_mem
    ], $doshik_company_report.prototype, "download", null);
    __decorate([
        $mol_mem
    ], $doshik_company_report.prototype, "Download_report", null);
    $.$doshik_company_report = $doshik_company_report;
})($ || ($ = {}));
//doshik/company/report/-view.tree/report.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $doshik_company_report extends $.$doshik_company_report {
            download() {
...
//doshik/company/report/report.view.ts
;
"use strict";
var $;
(function ($) {
    class $doshik_company extends $mol_book2_catalog {
        menu_title() {
            return "ДоШик Компания";
        }
        param() {
            return "company";
        }
        ...
        Report_page() {
            const obj = new this.$.$doshik_company_report();
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $doshik_company.prototype, "People_page", null);
    __decorate([
        $mol_mem
    ], $doshik_company.prototype, "Report_page", null);
    $.$doshik_company = $doshik_company;
})($ || ($ = {}));
//doshik/company/-view.tree/company.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $doshik_client extends $mol_book2_catalog {
        ...
        GitHub() {
            ...
            obj.uri = () => "https://github.com/Lyumih/doshik";
            return obj;
        }
        Steps_page() {
            const obj = new this.$.$doshik_client_steps();
            obj.doshik_value = (next) => this.doshik(next);
            return obj;
        }
        Found_page() {
    ...
    __decorate([
        $mol_mem
    ], $doshik_client.prototype, "doshik", null);
    __decorate([
        $mol_mem
    ], $doshik_client.prototype, "Theme", null);
    __decorate([
        $mol_mem
    ], $doshik_client.prototype, "Chat", null);
    __decorate([
        $mol_mem
